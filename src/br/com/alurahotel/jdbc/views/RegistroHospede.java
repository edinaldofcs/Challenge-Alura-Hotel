...
public class RegistroHospede extends JFrame {
	...
	public RegistroHospede(Integer registro) {
		...
		btnSalvar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(validar) {
					Hospede hospede = new Hospede(txtNome.getText(), txtSobrenome.getText(), txtDataN.getDate(), ComboNacionalidade.getSelectedItem().toString(), Long.parseLong(txtTelefone.getText()), registro);
					salvar(hospede);
		...
		txtNreserva.setText(registro.toString());
